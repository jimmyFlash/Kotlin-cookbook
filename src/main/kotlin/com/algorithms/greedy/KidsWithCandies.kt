...
fun main() {
    ...
    val candiesArr1 = intArrayOf(2,3,5,1,3)
    val extraCandies1 = 3
    val candiesArr2 = intArrayOf(4,2,1,1,2)
    val extraCandies2 = 1

    println(kidsWithCandies(candiesArr1, extraCandies1).contentToString())
    println(kidsWithCandies(candiesArr2, extraCandies2).contentToString())
}
...
fun kidsWithCandies(candies: IntArray, extraCandies: Int): BooleanArray{
    ...
    return BooleanArray(candies.size){
        candy -> candies[candy] + extraCandies >= maxCandies
    }
}